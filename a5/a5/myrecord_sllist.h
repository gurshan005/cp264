 ...
 * length  - the number of nodes of the linked list
 * start   - pointer pointing to the first node of the linked list
 */
 ...
 * 
 * @param sllp - address of a singly linked list structure.
 ...
 * @param score - the score data of the new record.
 */
